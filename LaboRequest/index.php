...
<body>
    <header class="header">
        <div class="container">
            <nav class="nav">
                <div class="logo"><a href=""><img src="logo2.png" alt="Logo2" width="40px" height="40px"><img src="logo.png" alt="Logo"></div></a>
                <a href="../LaboRequest/login/login.php">Encontrar Trabalhos</a>
                <a href="../LaboRequest/login/login.php">Procurar Empresas</a>
                <a href="../LaboRequest/login/login.php" class="login">Login</a>
                <a href="../LaboRequest/cadastro/cadastro.php" class="register">Cadastre-se</a>
            </nav>
        </div>
    </header>
